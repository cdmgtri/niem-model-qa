...
function facetTests(qa, niem) {
  ...
  describe("Facet", () => {
    ...
    describe("Facet field tests", () => {
      ...
      beforeAll( async () => {
        fieldTest = new FieldTest(qa.objects.facet, fieldFacets, release);
      });

      test("#individual fields", async () => {
        let fields = Object.getOwnPropertyNames( qa.objects.facet.field );
      ...
      test("#all fields", async () => {
        let results = await qa.objects.facet.run(fieldFacets, release);
