  ...
  describe("Type", () => {
    ...
    describe("Type unit tests", () => {
      ...
      test("#base_unknown", async () => {
        ...
        let test = await qa.objects.type.tests.base_unknown(types, release);
      ...
      test("#definition_missing_complex", async () => {
        ...
        let test = await qa.objects.type.tests.definition_missing_complex(types);
      ...
      test("#definition_missing_simple", async () => {
        ...
        let test = await qa.objects.type.tests.definition_missing_simple(types);
      ...
      test("#definition_phrase_complex", async () => {
        ...
        let test = await qa.objects.type.tests.definition_phrase_complex(types);
      ...
      test("#definition_phrase_simple", async () => {
        ...
        let test = await qa.objects.type.tests.definition_phrase_simple(types);
      ...
      test("#definition_spellcheck", async () => {
        ...
        let test = await qa.objects.type.tests.definition_spellcheck(types, release);
      ...
      test("#name_camelCase", async () => {
        ...
        let test = await qa.objects.type.tests.name_camelCase(types);
      ...
      test("#name_duplicate", async () => {
        ...
        let test = await qa.objects.type.tests.name_duplicate(types);
      ...
      test("#name_inconsistent_codeType", async () => {
        ...
        let test = await qa.objects.type.tests.name_inconsistent_codeType(types);
      ...
      test("#name_invalidChar", async () => {
        ...
        let test = await qa.objects.type.tests.name_invalidChar(types);
      ...
      test("#name_missing_simple", async () => {
        ...
        let test = await qa.objects.type.tests.name_missing_simple(types);
      ...
      test("#name_missing_complex", async () => {
        ...
        let test = await qa.objects.type.tests.name_missing_complex(types);
      ...
      test("#name_repTerm_type", async () => {
        ...
        let test = await qa.objects.type.tests.name_repTerm_type(types);
      ...
      test("#name_repTerm_simple", async () => {
        ...
        let test = await qa.objects.type.tests.name_repTerm_simple(types);
      ...
      test("#name_repTerm_complex", async () => {
        ...
        let test = await qa.objects.type.tests.name_repTerm_complex(types);
      ...
      test("#name_repTerm_codeType", async () => {
        ...
        let test = await qa.objects.type.tests.name_repTerm_codeType(types);
      ...
      test("#name_reservedTerm_type", async () => {
        ...
        let test = await qa.objects.type.tests.name_reservedTerm_type(types);
      ...
      test("#name_spellcheck", async () => {
        ...
        let test = await qa.objects.type.tests.name_spellcheck(types, release);
      ...
      test("#prefix_missing", async () => {
        ...
        let test = await qa.objects.type.tests.prefix_missing(types);
        let issues = test.issues;
      ...
      test("#prefix_unknown", async () => {
        ...
        let test = await qa.objects.type.tests.prefix_unknown(types, release);
      ...
      test("#style_missing", async () => {
        ...
        let test = await qa.objects.type.tests.style_missing(types);
      ...
      test("#style_unknown", async () => {
        ...
        let test = await qa.objects.type.tests.style_unknown(types);
